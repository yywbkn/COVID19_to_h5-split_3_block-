...
def save_image_to_h5py(path):
    ...
    result_file = h5py.File('COVID_test.h5', "w")
    ...
    for child_dir in os.listdir(path):
        ...
        for dir_image in os.listdir(child_path):
            ...
            result_file.create_dataset(f"test/{dir_image}/data", data=img, compression='gzip')
            result_file.create_dataset(f"test/{dir_image}/label", data=label_tmp)
...
save_image_to_h5py(r'F:\Program Files\pycharm\workspace03\IMA_revise_5fold\COVID19_to_h5\random_select_certain_number_image\split_1ci\data_covid-test')
